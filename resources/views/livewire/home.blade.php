    ...
    <main id="main">
		<div class="container">
			...
			<div class="wrap-main-slide">
				<div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
					<div class="item-slide">
						<img src="assets/images/main-slider-1-1.jfif" alt="" class="img-slide">
			...
			<div class="wrap-banner style-twin-default">
				<div class="banner-item">
					<a href="#" class="link-banner banner-effect-1">
						<figure><img src="assets/images/home-1-banner-1.jfif" alt="" width="580" height="190"></figure>
					</a>
				</div>
				<div class="banner-item">
					<a href="#" class="link-banner banner-effect-1">
						<figure><img src="assets/images/home-1-banner-2.jfif" alt="" width="580" height="190"></figure>
					</a>
				</div>
			</div>
			...
			<div class="wrap-show-advance-info-box style-1 has-countdown">
				<h3 class="title-box">Nouveautés</h3>
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{route('detail',['slug' =>$prod->nom])}}" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                        <figure><img src="{{asset('storage/images/'.$prod->image)}}" width="800" height="800" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                    </a>
			...
			<div class="wrap-show-advance-info-box style-1">
				<h3 class="title-box">Produits Les Plus Vendus</h3>
									...
									@foreach ($lastProducts as $prod)
                                        <div class="product product-style-2 equal-elem ">
                                            <div class="product-thumnail">
                                                ...
                                                <div class="group-flash">
                                                    <span class="flash-item sale-label">{{$prod->categories[0]->name}}</span>
                                                </div>
                                                <div class="wrap-btn">
                                                    <a href="{{route('detail',['slug' =>$prod->nom])}}" class="function-link">Voir</a>
                                                </div>
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="wrap-price"><ins><p class="product-price">{{$prod->prix}} F CFA</p></ins> <del><p class="product-price">$250.00</p></del></div>
                                            </div>
                                        </div>
                                    @endforeach
